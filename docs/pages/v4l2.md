...
### Build Requirements
V4L2 drivers are implemented as kernel modules. The driver modules plug into the videodev kernel module. Below two configuration will be enabled from kernel:
- CONFIG_VIDEO_V4L2=y ; 
...
- For SOC Implementation, V4L2 driver is required to support these IOCTL calls:
...
- The 11 other IOCTL calls are optional: 
VIDIOC_G_FBUF, VIDIOC_S_FBUF, VIDIOC_OVERLAY, VIDIOC_ENUMINPUT, VIDIOC_G_PARM, VIDIOC_G_STD, VIDIOC_S_STD, VIDIOC_ENUMSTD, VIDIOC_TRY_FMT, VIDIOC_CREATE_BUFS, VIDIOC_S_SELECTION.
...
Caller-->>Caller: opening video device file
...
SoC V4L2 Driver-->>Caller: return -1
...
Caller-->>Caller: closing video device file
